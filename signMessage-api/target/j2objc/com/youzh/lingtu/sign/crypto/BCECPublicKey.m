...
//  source: /Users/alen/Downloads/signMessage-api/src/main/java/com/youzh/lingtu/sign/crypto/BCECPublicKey.java
//
...
@interface ComYouzhLingtuSignCryptoBCECPublicKey () {
 @public
  NSString *algorithm_;
...
J2OBJC_FIELD_SETTER(ComYouzhLingtuSignCryptoBCECPublicKey, algorithm_, NSString *)
J2OBJC_FIELD_SETTER(ComYouzhLingtuSignCryptoBCECPublicKey, q_, OrgSpongycastleMathEcECPoint *)
J2OBJC_FIELD_SETTER(ComYouzhLingtuSignCryptoBCECPublicKey, ecSpec_, JavaSecuritySpecECParameterSpec *)
J2OBJC_FIELD_SETTER(ComYouzhLingtuSignCryptoBCECPublicKey, configuration_, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration>)

__attribute__((unused)) static JavaSecuritySpecECParameterSpec *ComYouzhLingtuSignCryptoBCECPublicKey_createSpecWithJavaSecuritySpecEllipticCurve_withOrgSpongycastleCryptoParamsECDomainParameters_(ComYouzhLingtuSignCryptoBCECPublicKey *self, JavaSecuritySpecEllipticCurve *ellipticCurve, OrgSpongycastleCryptoParamsECDomainParameters *dp);

__attribute__((unused)) static void ComYouzhLingtuSignCryptoBCECPublicKey_populateFromPubKeyInfoWithOrgSpongycastleAsn1X509SubjectPublicKeyInfo_(ComYouzhLingtuSignCryptoBCECPublicKey *self, OrgSpongycastleAsn1X509SubjectPublicKeyInfo *info);

__attribute__((unused)) static void ComYouzhLingtuSignCryptoBCECPublicKey_extractBytesWithByteArray_withInt_withJavaMathBigInteger_(ComYouzhLingtuSignCryptoBCECPublicKey *self, IOSByteArray *encKey, jint offSet, JavaMathBigInteger *bI);

__attribute__((unused)) static void ComYouzhLingtuSignCryptoBCECPublicKey_readObjectWithJavaIoObjectInputStream_(ComYouzhLingtuSignCryptoBCECPublicKey *self, JavaIoObjectInputStream *inArg);

__attribute__((unused)) static void ComYouzhLingtuSignCryptoBCECPublicKey_writeObjectWithJavaIoObjectOutputStream_(ComYouzhLingtuSignCryptoBCECPublicKey *self, JavaIoObjectOutputStream *outArg);

@implementation ComYouzhLingtuSignCryptoBCECPublicKey

- (instancetype)initWithNSString:(NSString *)algorithm
withComYouzhLingtuSignCryptoBCECPublicKey:(ComYouzhLingtuSignCryptoBCECPublicKey *)key {
  ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withComYouzhLingtuSignCryptoBCECPublicKey_(self, algorithm, key);
  return self;
}
...
withComYouzhLingtuSignCryptoConfigProviderConfiguration:(id<ComYouzhLingtuSignCryptoConfigProviderConfiguration>)configuration {
  ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withJavaSecuritySpecECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(self, algorithm, spec, configuration);
  return self;
}
...
withComYouzhLingtuSignCryptoConfigProviderConfiguration:(id<ComYouzhLingtuSignCryptoConfigProviderConfiguration>)configuration {
  ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withComYouzhLingtuSignCryptoUtilsECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(self, algorithm, spec, configuration);
  return self;
}
...
withComYouzhLingtuSignCryptoConfigProviderConfiguration:(id<ComYouzhLingtuSignCryptoConfigProviderConfiguration>)configuration {
  ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withJavaSecuritySpecECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(self, algorithm, params, spec, configuration);
  return self;
}
...
withComYouzhLingtuSignCryptoConfigProviderConfiguration:(id<ComYouzhLingtuSignCryptoConfigProviderConfiguration>)configuration {
  ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoUtilsECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(self, algorithm, params, spec, configuration);
  return self;
}
...
withOrgSpongycastleCryptoParamsECPublicKeyParameters:(OrgSpongycastleCryptoParamsECPublicKeyParameters *)params
withComYouzhLingtuSignCryptoConfigProviderConfiguration:(id<ComYouzhLingtuSignCryptoConfigProviderConfiguration>)configuration {
  ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(self, algorithm, params, configuration);
  return self;
}

- (instancetype)initWithJavaSecurityInterfacesECPublicKey:(id<JavaSecurityInterfacesECPublicKey>)key
  withComYouzhLingtuSignCryptoConfigProviderConfiguration:(id<ComYouzhLingtuSignCryptoConfigProviderConfiguration>)configuration {
  ComYouzhLingtuSignCryptoBCECPublicKey_initWithJavaSecurityInterfacesECPublicKey_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(self, key, configuration);
  return self;
}
...
withComYouzhLingtuSignCryptoConfigProviderConfiguration:(id<ComYouzhLingtuSignCryptoConfigProviderConfiguration>)configuration {
  ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleAsn1X509SubjectPublicKeyInfo_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(self, algorithm, info, configuration);
  return self;
}

- (JavaSecuritySpecECParameterSpec *)createSpecWithJavaSecuritySpecEllipticCurve:(JavaSecuritySpecEllipticCurve *)ellipticCurve
                               withOrgSpongycastleCryptoParamsECDomainParameters:(OrgSpongycastleCryptoParamsECDomainParameters *)dp {
  return ComYouzhLingtuSignCryptoBCECPublicKey_createSpecWithJavaSecuritySpecEllipticCurve_withOrgSpongycastleCryptoParamsECDomainParameters_(self, ellipticCurve, dp);
}

- (void)populateFromPubKeyInfoWithOrgSpongycastleAsn1X509SubjectPublicKeyInfo:(OrgSpongycastleAsn1X509SubjectPublicKeyInfo *)info {
  ComYouzhLingtuSignCryptoBCECPublicKey_populateFromPubKeyInfoWithOrgSpongycastleAsn1X509SubjectPublicKeyInfo_(self, info);
}
...
- (void)extractBytesWithByteArray:(IOSByteArray *)encKey
                          withInt:(jint)offSet
           withJavaMathBigInteger:(JavaMathBigInteger *)bI {
  ComYouzhLingtuSignCryptoBCECPublicKey_extractBytesWithByteArray_withInt_withJavaMathBigInteger_(self, encKey, offSet, bI);
}
...
- (jboolean)isEqual:(id)o {
  if (!([o isKindOfClass:[ComYouzhLingtuSignCryptoBCECPublicKey class]])) {
    return false;
  }
  ComYouzhLingtuSignCryptoBCECPublicKey *other = (ComYouzhLingtuSignCryptoBCECPublicKey *) cast_chk(o, [ComYouzhLingtuSignCryptoBCECPublicKey class]);
  return [((OrgSpongycastleMathEcECPoint *) nil_chk([self engineGetQ])) equalsWithOrgSpongycastleMathEcECPoint:[((ComYouzhLingtuSignCryptoBCECPublicKey *) nil_chk(other)) engineGetQ]] && ([((ComYouzhLingtuSignCryptoUtilsECParameterSpec *) nil_chk([self engineGetSpec])) isEqual:[other engineGetSpec]]);
}
...
- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)inArg {
  ComYouzhLingtuSignCryptoBCECPublicKey_readObjectWithJavaIoObjectInputStream_(self, inArg);
}

- (void)writeObjectWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)outArg {
  ComYouzhLingtuSignCryptoBCECPublicKey_writeObjectWithJavaIoObjectOutputStream_(self, outArg);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithNSString:withComYouzhLingtuSignCryptoBCECPublicKey:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "serialVersionUID", "J", .constantValue.asLong = ComYouzhLingtuSignCryptoBCECPublicKey_serialVersionUID, 0x18, -1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "LNSString;LComYouzhLingtuSignCryptoBCECPublicKey;", "LNSString;LJavaSecuritySpecECPublicKeySpec;LComYouzhLingtuSignCryptoConfigProviderConfiguration;", "LNSString;LComYouzhLingtuSignCryptoUtilsECPublicKeySpec;LComYouzhLingtuSignCryptoConfigProviderConfiguration;", "LNSString;LOrgSpongycastleCryptoParamsECPublicKeyParameters;LJavaSecuritySpecECParameterSpec;LComYouzhLingtuSignCryptoConfigProviderConfiguration;", "LNSString;LOrgSpongycastleCryptoParamsECPublicKeyParameters;LComYouzhLingtuSignCryptoUtilsECParameterSpec;LComYouzhLingtuSignCryptoConfigProviderConfiguration;", "LNSString;LOrgSpongycastleCryptoParamsECPublicKeyParameters;LComYouzhLingtuSignCryptoConfigProviderConfiguration;", "LJavaSecurityInterfacesECPublicKey;LComYouzhLingtuSignCryptoConfigProviderConfiguration;", "LNSString;LOrgSpongycastleAsn1X509SubjectPublicKeyInfo;LComYouzhLingtuSignCryptoConfigProviderConfiguration;", "createSpec", "LJavaSecuritySpecEllipticCurve;LOrgSpongycastleCryptoParamsECDomainParameters;", "populateFromPubKeyInfo", "LOrgSpongycastleAsn1X509SubjectPublicKeyInfo;", "extractBytes", "[BILJavaMathBigInteger;", "toString", "setPointFormat", "LNSString;", "equals", "LNSObject;", "hashCode", "readObject", "LJavaIoObjectInputStream;", "LJavaIoIOException;LJavaLangClassNotFoundException;", "writeObject", "LJavaIoObjectOutputStream;", "LJavaIoIOException;" };
  static const J2ObjcClassInfo _ComYouzhLingtuSignCryptoBCECPublicKey = { "BCECPublicKey", "com.youzh.lingtu.sign.crypto", ptrTable, methods, fields, 7, 0x1, 26, 6, -1, -1, -1, -1, -1 };
  return &_ComYouzhLingtuSignCryptoBCECPublicKey;
}

@end

void ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withComYouzhLingtuSignCryptoBCECPublicKey_(ComYouzhLingtuSignCryptoBCECPublicKey *self, NSString *algorithm, ComYouzhLingtuSignCryptoBCECPublicKey *key) {
  NSObject_init(self);
  self->algorithm_ = @"EC";
  self->algorithm_ = algorithm;
  self->q_ = ((ComYouzhLingtuSignCryptoBCECPublicKey *) nil_chk(key))->q_;
  self->ecSpec_ = key->ecSpec_;
  self->withCompression_ = key->withCompression_;
  self->configuration_ = key->configuration_;
}

ComYouzhLingtuSignCryptoBCECPublicKey *new_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withComYouzhLingtuSignCryptoBCECPublicKey_(NSString *algorithm, ComYouzhLingtuSignCryptoBCECPublicKey *key) {
  J2OBJC_NEW_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withComYouzhLingtuSignCryptoBCECPublicKey_, algorithm, key)
}

ComYouzhLingtuSignCryptoBCECPublicKey *create_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withComYouzhLingtuSignCryptoBCECPublicKey_(NSString *algorithm, ComYouzhLingtuSignCryptoBCECPublicKey *key) {
  J2OBJC_CREATE_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withComYouzhLingtuSignCryptoBCECPublicKey_, algorithm, key)
}

void ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withJavaSecuritySpecECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(ComYouzhLingtuSignCryptoBCECPublicKey *self, NSString *algorithm, JavaSecuritySpecECPublicKeySpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  NSObject_init(self);
  self->algorithm_ = @"EC";
  self->algorithm_ = algorithm;
...
ComYouzhLingtuSignCryptoBCECPublicKey *new_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withJavaSecuritySpecECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, JavaSecuritySpecECPublicKeySpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_NEW_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withJavaSecuritySpecECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, spec, configuration)
}

ComYouzhLingtuSignCryptoBCECPublicKey *create_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withJavaSecuritySpecECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, JavaSecuritySpecECPublicKeySpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_CREATE_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withJavaSecuritySpecECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, spec, configuration)
}

void ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withComYouzhLingtuSignCryptoUtilsECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(ComYouzhLingtuSignCryptoBCECPublicKey *self, NSString *algorithm, ComYouzhLingtuSignCryptoUtilsECPublicKeySpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  NSObject_init(self);
  self->algorithm_ = @"EC";
  self->algorithm_ = algorithm;
...
ComYouzhLingtuSignCryptoBCECPublicKey *new_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withComYouzhLingtuSignCryptoUtilsECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, ComYouzhLingtuSignCryptoUtilsECPublicKeySpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_NEW_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withComYouzhLingtuSignCryptoUtilsECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, spec, configuration)
}

ComYouzhLingtuSignCryptoBCECPublicKey *create_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withComYouzhLingtuSignCryptoUtilsECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, ComYouzhLingtuSignCryptoUtilsECPublicKeySpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_CREATE_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withComYouzhLingtuSignCryptoUtilsECPublicKeySpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, spec, configuration)
}

void ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withJavaSecuritySpecECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(ComYouzhLingtuSignCryptoBCECPublicKey *self, NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, JavaSecuritySpecECParameterSpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  NSObject_init(self);
  self->algorithm_ = @"EC";
  ...
  if (spec == nil) {
    ...
    self->ecSpec_ = ComYouzhLingtuSignCryptoBCECPublicKey_createSpecWithJavaSecuritySpecEllipticCurve_withOrgSpongycastleCryptoParamsECDomainParameters_(self, ellipticCurve, dp);
  }
  else {
    self->ecSpec_ = spec;
  }
...
ComYouzhLingtuSignCryptoBCECPublicKey *new_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withJavaSecuritySpecECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, JavaSecuritySpecECParameterSpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_NEW_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withJavaSecuritySpecECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, params, spec, configuration)
}

ComYouzhLingtuSignCryptoBCECPublicKey *create_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withJavaSecuritySpecECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, JavaSecuritySpecECParameterSpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_CREATE_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withJavaSecuritySpecECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, params, spec, configuration)
}

void ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoUtilsECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(ComYouzhLingtuSignCryptoBCECPublicKey *self, NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, ComYouzhLingtuSignCryptoUtilsECParameterSpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  NSObject_init(self);
  self->algorithm_ = @"EC";
  OrgSpongycastleCryptoParamsECDomainParameters *dp = [((OrgSpongycastleCryptoParamsECPublicKeyParameters *) nil_chk(params)) getParameters];
  self->algorithm_ = algorithm;
...
ComYouzhLingtuSignCryptoBCECPublicKey *new_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoUtilsECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, ComYouzhLingtuSignCryptoUtilsECParameterSpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_NEW_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoUtilsECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, params, spec, configuration)
}

ComYouzhLingtuSignCryptoBCECPublicKey *create_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoUtilsECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, ComYouzhLingtuSignCryptoUtilsECParameterSpec *spec, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_CREATE_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoUtilsECParameterSpec_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, params, spec, configuration)
}

void ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(ComYouzhLingtuSignCryptoBCECPublicKey *self, NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  NSObject_init(self);
  self->algorithm_ = @"EC";
  self->algorithm_ = algorithm;
...
ComYouzhLingtuSignCryptoBCECPublicKey *new_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_NEW_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, params, configuration)
}

ComYouzhLingtuSignCryptoBCECPublicKey *create_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, OrgSpongycastleCryptoParamsECPublicKeyParameters *params, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_CREATE_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withOrgSpongycastleCryptoParamsECPublicKeyParameters_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, params, configuration)
}

void ComYouzhLingtuSignCryptoBCECPublicKey_initWithJavaSecurityInterfacesECPublicKey_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(ComYouzhLingtuSignCryptoBCECPublicKey *self, id<JavaSecurityInterfacesECPublicKey> key, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  NSObject_init(self);
  self->algorithm_ = @"EC";
...
ComYouzhLingtuSignCryptoBCECPublicKey *new_ComYouzhLingtuSignCryptoBCECPublicKey_initWithJavaSecurityInterfacesECPublicKey_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(id<JavaSecurityInterfacesECPublicKey> key, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_NEW_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithJavaSecurityInterfacesECPublicKey_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, key, configuration)
}

ComYouzhLingtuSignCryptoBCECPublicKey *create_ComYouzhLingtuSignCryptoBCECPublicKey_initWithJavaSecurityInterfacesECPublicKey_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(id<JavaSecurityInterfacesECPublicKey> key, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_CREATE_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithJavaSecurityInterfacesECPublicKey_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, key, configuration)
}

void ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleAsn1X509SubjectPublicKeyInfo_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(ComYouzhLingtuSignCryptoBCECPublicKey *self, NSString *algorithm, OrgSpongycastleAsn1X509SubjectPublicKeyInfo *info, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  NSObject_init(self);
  self->algorithm_ = @"EC";
  self->algorithm_ = algorithm;
  self->configuration_ = configuration;
...
ComYouzhLingtuSignCryptoBCECPublicKey *new_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleAsn1X509SubjectPublicKeyInfo_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, OrgSpongycastleAsn1X509SubjectPublicKeyInfo *info, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_NEW_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withOrgSpongycastleAsn1X509SubjectPublicKeyInfo_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, info, configuration)
}

ComYouzhLingtuSignCryptoBCECPublicKey *create_ComYouzhLingtuSignCryptoBCECPublicKey_initWithNSString_withOrgSpongycastleAsn1X509SubjectPublicKeyInfo_withComYouzhLingtuSignCryptoConfigProviderConfiguration_(NSString *algorithm, OrgSpongycastleAsn1X509SubjectPublicKeyInfo *info, id<ComYouzhLingtuSignCryptoConfigProviderConfiguration> configuration) {
  J2OBJC_CREATE_IMPL(ComYouzhLingtuSignCryptoBCECPublicKey, initWithNSString_withOrgSpongycastleAsn1X509SubjectPublicKeyInfo_withComYouzhLingtuSignCryptoConfigProviderConfiguration_, algorithm, info, configuration)
}

JavaSecuritySpecECParameterSpec *ComYouzhLingtuSignCryptoBCECPublicKey_createSpecWithJavaSecuritySpecEllipticCurve_withOrgSpongycastleCryptoParamsECDomainParameters_(ComYouzhLingtuSignCryptoBCECPublicKey *self, JavaSecuritySpecEllipticCurve *ellipticCurve, OrgSpongycastleCryptoParamsECDomainParameters *dp) {
...
void ComYouzhLingtuSignCryptoBCECPublicKey_populateFromPubKeyInfoWithOrgSpongycastleAsn1X509SubjectPublicKeyInfo_(ComYouzhLingtuSignCryptoBCECPublicKey *self, OrgSpongycastleAsn1X509SubjectPublicKeyInfo *info) {
...
void ComYouzhLingtuSignCryptoBCECPublicKey_extractBytesWithByteArray_withInt_withJavaMathBigInteger_(ComYouzhLingtuSignCryptoBCECPublicKey *self, IOSByteArray *encKey, jint offSet, JavaMathBigInteger *bI) {
...
void ComYouzhLingtuSignCryptoBCECPublicKey_readObjectWithJavaIoObjectInputStream_(ComYouzhLingtuSignCryptoBCECPublicKey *self, JavaIoObjectInputStream *inArg) {
  [((JavaIoObjectInputStream *) nil_chk(inArg)) defaultReadObject];
  IOSByteArray *enc = (IOSByteArray *) cast_chk([inArg readObject], [IOSByteArray class]);
  ComYouzhLingtuSignCryptoBCECPublicKey_populateFromPubKeyInfoWithOrgSpongycastleAsn1X509SubjectPublicKeyInfo_(self, OrgSpongycastleAsn1X509SubjectPublicKeyInfo_getInstanceWithId_(OrgSpongycastleAsn1ASN1Primitive_fromByteArrayWithByteArray_(enc)));
  self->configuration_ = JreLoadStatic(ComYouzhLingtuSignCryptoConfigBouncyCastleProvider, CONFIGURATION);
}

void ComYouzhLingtuSignCryptoBCECPublicKey_writeObjectWithJavaIoObjectOutputStream_(ComYouzhLingtuSignCryptoBCECPublicKey *self, JavaIoObjectOutputStream *outArg) {
  [((JavaIoObjectOutputStream *) nil_chk(outArg)) defaultWriteObject];
  [outArg writeObjectWithId:[self getEncoded]];
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ComYouzhLingtuSignCryptoBCECPublicKey)
