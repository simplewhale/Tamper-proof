...
FOUNDATION_EXPORT void OrgApacheCommonsCodecBinaryHex_initWithNSString_(OrgApacheCommonsCodecBinaryHex *self, NSString *csName);

FOUNDATION_EXPORT OrgApacheCommonsCodecBinaryHex *new_OrgApacheCommonsCodecBinaryHex_initWithNSString_(NSString *csName) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsCodecBinaryHex *create_OrgApacheCommonsCodecBinaryHex_initWithNSString_(NSString *csName);
