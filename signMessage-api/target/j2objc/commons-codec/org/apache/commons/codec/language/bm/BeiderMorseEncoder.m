...
//  source: /Users/alen/Downloads/signMessage-api/target/classes/commons-codec/org/apache/commons/codec/language/bm/BeiderMorseEncoder.java
//
...
- (id)encodeWithId:(id)source {
  if (!([source isKindOfClass:[NSString class]])) {
    @throw new_OrgApacheCommonsCodecEncoderException_initWithNSString_(@"BeiderMorseEncoder encode parameter is not of type String");
  }
...
- (void)setConcatWithBoolean:(jboolean)concat {
  self->engine_ = new_OrgApacheCommonsCodecLanguageBmPhoneticEngine_initWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withBoolean_([((OrgApacheCommonsCodecLanguageBmPhoneticEngine *) nil_chk(self->engine_)) getNameType], [((OrgApacheCommonsCodecLanguageBmPhoneticEngine *) nil_chk(self->engine_)) getRuleType], concat);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "encode", "LNSObject;", "LOrgApacheCommonsCodecEncoderException;", "LNSString;", "setConcat", "Z", "setNameType", "LOrgApacheCommonsCodecLanguageBmNameType;", "setRuleType", "LOrgApacheCommonsCodecLanguageBmRuleType;" };
  static const J2ObjcClassInfo _OrgApacheCommonsCodecLanguageBmBeiderMorseEncoder = { "BeiderMorseEncoder", "org.apache.commons.codec.language.bm", ptrTable, methods, fields, 7, 0x1, 9, 1, -1, -1, -1, -1, -1 };
...
void OrgApacheCommonsCodecLanguageBmBeiderMorseEncoder_init(OrgApacheCommonsCodecLanguageBmBeiderMorseEncoder *self) {
  NSObject_init(self);
  self->engine_ = new_OrgApacheCommonsCodecLanguageBmPhoneticEngine_initWithOrgApacheCommonsCodecLanguageBmNameType_withOrgApacheCommonsCodecLanguageBmRuleType_withBoolean_(JreLoadEnum(OrgApacheCommonsCodecLanguageBmNameType, GENERIC), JreLoadEnum(OrgApacheCommonsCodecLanguageBmRuleType, APPROX), true);
}
