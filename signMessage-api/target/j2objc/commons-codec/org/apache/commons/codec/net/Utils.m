...
//  source: /Users/alen/Downloads/signMessage-api/target/classes/commons-codec/org/apache/commons/codec/net/Utils.java
//
...
jint OrgApacheCommonsCodecNetUtils_digit16WithByte_(jbyte b) {
  ...
  jint i = JavaLangCharacter_digitWithChar_withInt_((jchar) b, 16);
  if (i == -1) {
