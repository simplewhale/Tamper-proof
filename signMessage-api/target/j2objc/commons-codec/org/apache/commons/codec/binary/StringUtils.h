...
FOUNDATION_EXPORT OrgApacheCommonsCodecBinaryStringUtils *new_OrgApacheCommonsCodecBinaryStringUtils_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheCommonsCodecBinaryStringUtils *create_OrgApacheCommonsCodecBinaryStringUtils_init(void);
