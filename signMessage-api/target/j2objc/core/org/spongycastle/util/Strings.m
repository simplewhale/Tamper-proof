...
//  source: /Users/alen/Downloads/signMessage-api/target/classes/core/org/spongycastle/util/Strings.java
//
  ...
  while (i < bytes->size_) {
    ...
    if ((IOSByteArray_Get(bytes, i) & (jint) 0xf0) == (jint) 0xf0) {
      ...
      *IOSCharArray_GetRef(cs, length++) = W1;
      ...
      ch = (jchar) ((JreLShift32((IOSByteArray_Get(bytes, i) & (jint) 0x0f), 12)) | (JreLShift32((IOSByteArray_Get(bytes, i + 1) & (jint) 0x3f), 6)) | (IOSByteArray_Get(bytes, i + 2) & (jint) 0x3f));
      i += 3;
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgSpongycastleUtilStrings_1 = { "", "org.spongycastle.util", ptrTable, methods, NULL, 7, 0x8018, 2, 0, 0, -1, -1, 1, -1 };
