...
#include "org/spongycastle/crypto/ec/ECElGamalEncryptor.h"
...
@interface OrgSpongycastleCryptoEcECElGamalEncryptor () {
 @public
...
J2OBJC_FIELD_SETTER(OrgSpongycastleCryptoEcECElGamalEncryptor, key_, OrgSpongycastleCryptoParamsECPublicKeyParameters *)
J2OBJC_FIELD_SETTER(OrgSpongycastleCryptoEcECElGamalEncryptor, random_, JavaSecuritySecureRandom *)

@implementation OrgSpongycastleCryptoEcECElGamalEncryptor

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgSpongycastleCryptoEcECElGamalEncryptor_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[2].selector = @selector(encryptWithOrgSpongycastleMathEcECPoint:);
  ...
  static const J2ObjcClassInfo _OrgSpongycastleCryptoEcECElGamalEncryptor = { "ECElGamalEncryptor", "org.spongycastle.crypto.ec", ptrTable, methods, fields, 7, 0x1, 4, 2, -1, -1, -1, -1, -1 };
  return &_OrgSpongycastleCryptoEcECElGamalEncryptor;
}

@end

void OrgSpongycastleCryptoEcECElGamalEncryptor_init(OrgSpongycastleCryptoEcECElGamalEncryptor *self) {
  NSObject_init(self);
}

OrgSpongycastleCryptoEcECElGamalEncryptor *new_OrgSpongycastleCryptoEcECElGamalEncryptor_init() {
  J2OBJC_NEW_IMPL(OrgSpongycastleCryptoEcECElGamalEncryptor, init)
}

OrgSpongycastleCryptoEcECElGamalEncryptor *create_OrgSpongycastleCryptoEcECElGamalEncryptor_init() {
  J2OBJC_CREATE_IMPL(OrgSpongycastleCryptoEcECElGamalEncryptor, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgSpongycastleCryptoEcECElGamalEncryptor)
