...
@interface OrgSpongycastleCryptoGeneratorsBCrypt () {
 @public
  IOSIntArray *S_;
  IOSIntArray *P_;
}
...
J2OBJC_FIELD_SETTER(OrgSpongycastleCryptoGeneratorsBCrypt, S_, IOSIntArray *)
J2OBJC_FIELD_SETTER(OrgSpongycastleCryptoGeneratorsBCrypt, P_, IOSIntArray *)

inline IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_get_MAGIC_STRING(void);
static IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_MAGIC_STRING;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgSpongycastleCryptoGeneratorsBCrypt, MAGIC_STRING, IOSIntArray *)

inline IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_get_KP(void);
static IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_KP;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgSpongycastleCryptoGeneratorsBCrypt, KP, IOSIntArray *)

inline IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_get_KS0(void);
static IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_KS0;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgSpongycastleCryptoGeneratorsBCrypt, KS0, IOSIntArray *)

inline IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_get_KS1(void);
static IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_KS1;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgSpongycastleCryptoGeneratorsBCrypt, KS1, IOSIntArray *)

inline IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_get_KS2(void);
static IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_KS2;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgSpongycastleCryptoGeneratorsBCrypt, KS2, IOSIntArray *)

inline IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_get_KS3(void);
static IOSIntArray *OrgSpongycastleCryptoGeneratorsBCrypt_KS3;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgSpongycastleCryptoGeneratorsBCrypt, KS3, IOSIntArray *)

inline jint OrgSpongycastleCryptoGeneratorsBCrypt_get_ROUNDS(void);
#define OrgSpongycastleCryptoGeneratorsBCrypt_ROUNDS 16
J2OBJC_STATIC_FIELD_CONSTANT(OrgSpongycastleCryptoGeneratorsBCrypt, ROUNDS, jint)

inline jint OrgSpongycastleCryptoGeneratorsBCrypt_get_SBOX_SK(void);
#define OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK 256
J2OBJC_STATIC_FIELD_CONSTANT(OrgSpongycastleCryptoGeneratorsBCrypt, SBOX_SK, jint)

inline jint OrgSpongycastleCryptoGeneratorsBCrypt_get_SBOX_SK2(void);
#define OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK2 512
J2OBJC_STATIC_FIELD_CONSTANT(OrgSpongycastleCryptoGeneratorsBCrypt, SBOX_SK2, jint)

inline jint OrgSpongycastleCryptoGeneratorsBCrypt_get_SBOX_SK3(void);
#define OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK3 768
J2OBJC_STATIC_FIELD_CONSTANT(OrgSpongycastleCryptoGeneratorsBCrypt, SBOX_SK3, jint)

inline jint OrgSpongycastleCryptoGeneratorsBCrypt_get_P_SZ(void);
#define OrgSpongycastleCryptoGeneratorsBCrypt_P_SZ 18
J2OBJC_STATIC_FIELD_CONSTANT(OrgSpongycastleCryptoGeneratorsBCrypt, P_SZ, jint)

__attribute__((unused)) static void OrgSpongycastleCryptoGeneratorsBCrypt_init(OrgSpongycastleCryptoGeneratorsBCrypt *self);

__attribute__((unused)) static OrgSpongycastleCryptoGeneratorsBCrypt *new_OrgSpongycastleCryptoGeneratorsBCrypt_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgSpongycastleCryptoGeneratorsBCrypt *create_OrgSpongycastleCryptoGeneratorsBCrypt_init(void);

__attribute__((unused)) static jint OrgSpongycastleCryptoGeneratorsBCrypt_FWithInt_(OrgSpongycastleCryptoGeneratorsBCrypt *self, jint x);

__attribute__((unused)) static void OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithInt_withInt_withIntArray_(OrgSpongycastleCryptoGeneratorsBCrypt *self, jint xl, jint xr, IOSIntArray *table);

__attribute__((unused)) static void OrgSpongycastleCryptoGeneratorsBCrypt_initState(OrgSpongycastleCryptoGeneratorsBCrypt *self);

__attribute__((unused)) static void OrgSpongycastleCryptoGeneratorsBCrypt_cyclicXorKeyWithByteArray_(OrgSpongycastleCryptoGeneratorsBCrypt *self, IOSByteArray *key);

__attribute__((unused)) static IOSByteArray *OrgSpongycastleCryptoGeneratorsBCrypt_encryptMagicString(OrgSpongycastleCryptoGeneratorsBCrypt *self);

__attribute__((unused)) static void OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithSaltWithIntArray_withIntArray_withInt_withInt_(OrgSpongycastleCryptoGeneratorsBCrypt *self, IOSIntArray *table, IOSIntArray *salt32Bit, jint iv1, jint iv2);

__attribute__((unused)) static IOSByteArray *OrgSpongycastleCryptoGeneratorsBCrypt_deriveRawKeyWithInt_withByteArray_withByteArray_(OrgSpongycastleCryptoGeneratorsBCrypt *self, jint cost, IOSByteArray *salt, IOSByteArray *psw);

J2OBJC_INITIALIZED_DEFN(OrgSpongycastleCryptoGeneratorsBCrypt)

@implementation OrgSpongycastleCryptoGeneratorsBCrypt

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgSpongycastleCryptoGeneratorsBCrypt_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (jint)FWithInt:(jint)x {
  return OrgSpongycastleCryptoGeneratorsBCrypt_FWithInt_(self, x);
}

- (void)processTableWithInt:(jint)xl
                    withInt:(jint)xr
               withIntArray:(IOSIntArray *)table {
  OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithInt_withInt_withIntArray_(self, xl, xr, table);
}

- (void)initState {
  OrgSpongycastleCryptoGeneratorsBCrypt_initState(self);
}

- (void)cyclicXorKeyWithByteArray:(IOSByteArray *)key {
  OrgSpongycastleCryptoGeneratorsBCrypt_cyclicXorKeyWithByteArray_(self, key);
}

- (IOSByteArray *)encryptMagicString {
  return OrgSpongycastleCryptoGeneratorsBCrypt_encryptMagicString(self);
}
...
- (void)processTableWithSaltWithIntArray:(IOSIntArray *)table
                            withIntArray:(IOSIntArray *)salt32Bit
                                 withInt:(jint)iv1
                                 withInt:(jint)iv2 {
  OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithSaltWithIntArray_withIntArray_withInt_withInt_(self, table, salt32Bit, iv1, iv2);
}

- (IOSByteArray *)deriveRawKeyWithInt:(jint)cost
                        withByteArray:(IOSByteArray *)salt
                        withByteArray:(IOSByteArray *)psw {
  return OrgSpongycastleCryptoGeneratorsBCrypt_deriveRawKeyWithInt_withByteArray_withByteArray_(self, cost, salt, psw);
}

+ (IOSByteArray *)generateWithByteArray:(IOSByteArray *)password
                          withByteArray:(IOSByteArray *)salt
                                withInt:(jint)cost {
  return OrgSpongycastleCryptoGeneratorsBCrypt_generateWithByteArray_withByteArray_withInt_(password, salt, cost);
}
...
void OrgSpongycastleCryptoGeneratorsBCrypt_initState(OrgSpongycastleCryptoGeneratorsBCrypt *self) {
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(OrgSpongycastleCryptoGeneratorsBCrypt_KS0, 0, self->S_, 0, OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(OrgSpongycastleCryptoGeneratorsBCrypt_KS1, 0, self->S_, OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK, OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(OrgSpongycastleCryptoGeneratorsBCrypt_KS2, 0, self->S_, OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK2, OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(OrgSpongycastleCryptoGeneratorsBCrypt_KS3, 0, self->S_, OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK3, OrgSpongycastleCryptoGeneratorsBCrypt_SBOX_SK);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(OrgSpongycastleCryptoGeneratorsBCrypt_KP, 0, self->P_, 0, OrgSpongycastleCryptoGeneratorsBCrypt_P_SZ);
}

void OrgSpongycastleCryptoGeneratorsBCrypt_cyclicXorKeyWithByteArray_(OrgSpongycastleCryptoGeneratorsBCrypt *self, IOSByteArray *key) {
  jint keyLength = ((IOSByteArray *) nil_chk(key))->size_;
  jint keyIndex = 0;
  for (jint i = 0; i < OrgSpongycastleCryptoGeneratorsBCrypt_P_SZ; i++) {
...
IOSByteArray *OrgSpongycastleCryptoGeneratorsBCrypt_encryptMagicString(OrgSpongycastleCryptoGeneratorsBCrypt *self) {
  IOSIntArray *text = [IOSIntArray newArrayWithInts:(jint[]){ IOSIntArray_Get(nil_chk(OrgSpongycastleCryptoGeneratorsBCrypt_MAGIC_STRING), 0), IOSIntArray_Get(OrgSpongycastleCryptoGeneratorsBCrypt_MAGIC_STRING, 1), IOSIntArray_Get(OrgSpongycastleCryptoGeneratorsBCrypt_MAGIC_STRING, 2), IOSIntArray_Get(OrgSpongycastleCryptoGeneratorsBCrypt_MAGIC_STRING, 3), IOSIntArray_Get(OrgSpongycastleCryptoGeneratorsBCrypt_MAGIC_STRING, 4), IOSIntArray_Get(OrgSpongycastleCryptoGeneratorsBCrypt_MAGIC_STRING, 5) } count:6];
  for (jint i = 0; i < 64; i++) {
    for (jint j = 0; j < OrgSpongycastleCryptoGeneratorsBCrypt_MAGIC_STRING_LENGTH; j += 2) {
      jint left = IOSIntArray_Get(text, j);
      jint right = IOSIntArray_Get(text, j + 1);
      left ^= IOSIntArray_Get(nil_chk(self->P_), 0);
      for (jint k = 1; k < OrgSpongycastleCryptoGeneratorsBCrypt_ROUNDS; k += 2) {
        right ^= OrgSpongycastleCryptoGeneratorsBCrypt_FWithInt_(self, left) ^ IOSIntArray_Get(self->P_, k);
        left ^= OrgSpongycastleCryptoGeneratorsBCrypt_FWithInt_(self, right) ^ IOSIntArray_Get(self->P_, k + 1);
      }
      right ^= IOSIntArray_Get(self->P_, OrgSpongycastleCryptoGeneratorsBCrypt_ROUNDS + 1);
      *IOSIntArray_GetRef(text, j) = right;
      *IOSIntArray_GetRef(text, j + 1) = left;
    }
  }
  IOSByteArray *result = [IOSByteArray newArrayWithLength:24];
  OrgSpongycastleUtilPack_intToBigEndianWithIntArray_withByteArray_withInt_(text, result, 0);
  OrgSpongycastleUtilArrays_fillWithIntArray_withInt_(text, 0);
  OrgSpongycastleUtilArrays_fillWithIntArray_withInt_(self->P_, 0);
  OrgSpongycastleUtilArrays_fillWithIntArray_withInt_(self->S_, 0);
  return result;
}

void OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithSaltWithIntArray_withIntArray_withInt_withInt_(OrgSpongycastleCryptoGeneratorsBCrypt *self, IOSIntArray *table, IOSIntArray *salt32Bit, jint iv1, jint iv2) {
  ...
  for (jint s = 0; s < size; s += 4) {
    ...
    *IOSIntArray_GetRef(table, s + 1) = xl;
    ...
    for (jint i = 1; i < OrgSpongycastleCryptoGeneratorsBCrypt_ROUNDS; i += 2) {
      yr ^= OrgSpongycastleCryptoGeneratorsBCrypt_FWithInt_(self, yl) ^ IOSIntArray_Get(self->P_, i);
      yl ^= OrgSpongycastleCryptoGeneratorsBCrypt_FWithInt_(self, yr) ^ IOSIntArray_Get(self->P_, i + 1);
    }
    yr ^= IOSIntArray_Get(self->P_, OrgSpongycastleCryptoGeneratorsBCrypt_ROUNDS + 1);
...
IOSByteArray *OrgSpongycastleCryptoGeneratorsBCrypt_deriveRawKeyWithInt_withByteArray_withByteArray_(OrgSpongycastleCryptoGeneratorsBCrypt *self, jint cost, IOSByteArray *salt, IOSByteArray *psw) {
  if (((IOSByteArray *) nil_chk(salt))->size_ != 16) {
    @throw new_OrgSpongycastleCryptoDataLengthException_initWithNSString_(@"Invalid salt size: 16 bytes expected.");
  }
  if (cost < 4 || cost > 31) {
  ...
  OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_withIntArray_(salt, 0, salt32Bit);
  ...
  *IOSIntArray_GetRef(salt32Bit2, 3) = IOSIntArray_Get(salt32Bit, 1);
  OrgSpongycastleCryptoGeneratorsBCrypt_cyclicXorKeyWithByteArray_(self, psw);
  OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithSaltWithIntArray_withIntArray_withInt_withInt_(self, self->P_, salt32Bit, 0, 0);
  OrgSpongycastleUtilArrays_fillWithIntArray_withInt_(salt32Bit, 0);
  OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithSaltWithIntArray_withIntArray_withInt_withInt_(self, self->S_, salt32Bit2, IOSIntArray_Get(self->P_, ((IOSIntArray *) nil_chk(self->P_))->size_ - 2), IOSIntArray_Get(self->P_, self->P_->size_ - 1));
  OrgSpongycastleUtilArrays_fillWithIntArray_withInt_(salt32Bit2, 0);
  jint rounds = JreLShift32(1, cost);
  for (jint i = 0; i != rounds; i++) {
    OrgSpongycastleCryptoGeneratorsBCrypt_cyclicXorKeyWithByteArray_(self, psw);
    OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithInt_withInt_withIntArray_(self, 0, 0, self->P_);
    OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithInt_withInt_withIntArray_(self, IOSIntArray_Get(self->P_, OrgSpongycastleCryptoGeneratorsBCrypt_P_SZ - 2), IOSIntArray_Get(self->P_, OrgSpongycastleCryptoGeneratorsBCrypt_P_SZ - 1), self->S_);
    OrgSpongycastleCryptoGeneratorsBCrypt_cyclicXorKeyWithByteArray_(self, salt);
    OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithInt_withInt_withIntArray_(self, 0, 0, self->P_);
    OrgSpongycastleCryptoGeneratorsBCrypt_processTableWithInt_withInt_withIntArray_(self, IOSIntArray_Get(self->P_, OrgSpongycastleCryptoGeneratorsBCrypt_P_SZ - 2), IOSIntArray_Get(self->P_, OrgSpongycastleCryptoGeneratorsBCrypt_P_SZ - 1), self->S_);
  }
  return OrgSpongycastleCryptoGeneratorsBCrypt_encryptMagicString(self);
...
IOSByteArray *OrgSpongycastleCryptoGeneratorsBCrypt_generateWithByteArray_withByteArray_withInt_(IOSByteArray *password, IOSByteArray *salt, jint cost) {
  OrgSpongycastleCryptoGeneratorsBCrypt_initialize();
  if (password == nil || salt == nil) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"Password and salt are required");
  }
  if (salt->size_ != OrgSpongycastleCryptoGeneratorsBCrypt_SALT_SIZE_BYTES) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"BCrypt salt must be 128 bits");
  }
  if (password->size_ > OrgSpongycastleCryptoGeneratorsBCrypt_MAX_PASSWORD_BYTES) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"BCrypt password must be <= 72 bytes");
  }
  if (cost < OrgSpongycastleCryptoGeneratorsBCrypt_MIN_COST || cost > OrgSpongycastleCryptoGeneratorsBCrypt_MAX_COST) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"BCrypt cost must be from 4..31");
  }
  return OrgSpongycastleCryptoGeneratorsBCrypt_deriveRawKeyWithInt_withByteArray_withByteArray_(new_OrgSpongycastleCryptoGeneratorsBCrypt_init(), cost, salt, password);
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgSpongycastleCryptoGeneratorsBCrypt)
