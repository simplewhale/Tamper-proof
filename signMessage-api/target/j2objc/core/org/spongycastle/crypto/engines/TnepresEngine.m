...
#include "org/spongycastle/crypto/engines/TnepresEngine.h"
#include "org/spongycastle/util/Pack.h"

@implementation OrgSpongycastleCryptoEnginesTnepresEngine

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgSpongycastleCryptoEnginesTnepresEngine_init(self);
  return self;
}
...
- (IOSIntArray *)makeWorkingKeyWithByteArray:(IOSByteArray *)key {
  ...
  for (off = ((IOSByteArray *) nil_chk(key))->size_ - 4; off > 0; off -= 4) {
    *IOSIntArray_GetRef(kPad, length++) = OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(key, off);
  }
  if (off == 0) {
    *IOSIntArray_GetRef(kPad, length++) = OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(key, 0);
    if (length < 8) {
...
- (void)encryptBlockWithByteArray:(IOSByteArray *)input
                    ...
                    withByteArray:(IOSByteArray *)output
                          withInt:(jint)outOff {
  X3_ = OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff);
  X2_ = OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 4);
  X1_ = OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 8);
  X0_ = OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 12);
  ...
  OrgSpongycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(IOSIntArray_Get(nil_chk(wKey_), 131) ^ X3_, output, outOff);
  OrgSpongycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(IOSIntArray_Get(nil_chk(wKey_), 130) ^ X2_, output, outOff + 4);
  OrgSpongycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(IOSIntArray_Get(nil_chk(wKey_), 129) ^ X1_, output, outOff + 8);
  OrgSpongycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(IOSIntArray_Get(nil_chk(wKey_), 128) ^ X0_, output, outOff + 12);
}
...
- (void)decryptBlockWithByteArray:(IOSByteArray *)input
                    ...
                    withByteArray:(IOSByteArray *)output
                          withInt:(jint)outOff {
  X3_ = IOSIntArray_Get(nil_chk(wKey_), 131) ^ OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff);
  X2_ = IOSIntArray_Get(nil_chk(wKey_), 130) ^ OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 4);
  X1_ = IOSIntArray_Get(nil_chk(wKey_), 129) ^ OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 8);
  X0_ = IOSIntArray_Get(nil_chk(wKey_), 128) ^ OrgSpongycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 12);
  ...
  [self inverseLT];
  [self ib0WithInt:X0_ withInt:X1_ withInt:X2_ withInt:X3_];
  OrgSpongycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(X3_ ^ IOSIntArray_Get(nil_chk(wKey_), 3), output, outOff);
  OrgSpongycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(X2_ ^ IOSIntArray_Get(nil_chk(wKey_), 2), output, outOff + 4);
  OrgSpongycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(X1_ ^ IOSIntArray_Get(nil_chk(wKey_), 1), output, outOff + 8);
  OrgSpongycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(X0_ ^ IOSIntArray_Get(nil_chk(wKey_), 0), output, outOff + 12);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgSpongycastleCryptoEnginesTnepresEngine = { "TnepresEngine", "org.spongycastle.crypto.engines", ptrTable, methods, NULL, 7, 0x11, 5, 0, -1, -1, -1, -1, -1 };
  return &_OrgSpongycastleCryptoEnginesTnepresEngine;
}

@end

void OrgSpongycastleCryptoEnginesTnepresEngine_init(OrgSpongycastleCryptoEnginesTnepresEngine *self) {
  OrgSpongycastleCryptoEnginesSerpentEngineBase_init(self);
}

OrgSpongycastleCryptoEnginesTnepresEngine *new_OrgSpongycastleCryptoEnginesTnepresEngine_init() {
  J2OBJC_NEW_IMPL(OrgSpongycastleCryptoEnginesTnepresEngine, init)
}

OrgSpongycastleCryptoEnginesTnepresEngine *create_OrgSpongycastleCryptoEnginesTnepresEngine_init() {
  J2OBJC_CREATE_IMPL(OrgSpongycastleCryptoEnginesTnepresEngine, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgSpongycastleCryptoEnginesTnepresEngine)
