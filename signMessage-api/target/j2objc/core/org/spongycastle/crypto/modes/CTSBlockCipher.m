...
#include "org/spongycastle/crypto/modes/CTSBlockCipher.h"

@interface OrgSpongycastleCryptoModesCTSBlockCipher () {
 @public
  jint blockSize_;
}
...
@implementation OrgSpongycastleCryptoModesCTSBlockCipher

- (instancetype)initWithOrgSpongycastleCryptoBlockCipher:(id<OrgSpongycastleCryptoBlockCipher>)cipher {
  OrgSpongycastleCryptoModesCTSBlockCipher_initWithOrgSpongycastleCryptoBlockCipher_(self, cipher);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgSpongycastleCryptoModesCTSBlockCipher = { "CTSBlockCipher", "org.spongycastle.crypto.modes", ptrTable, methods, fields, 7, 0x1, 6, 1, -1, -1, -1, -1, -1 };
  return &_OrgSpongycastleCryptoModesCTSBlockCipher;
}

@end

void OrgSpongycastleCryptoModesCTSBlockCipher_initWithOrgSpongycastleCryptoBlockCipher_(OrgSpongycastleCryptoModesCTSBlockCipher *self, id<OrgSpongycastleCryptoBlockCipher> cipher) {
  OrgSpongycastleCryptoBufferedBlockCipher_init(self);
  if ([cipher isKindOfClass:[OrgSpongycastleCryptoStreamBlockCipher class]]) {
...
OrgSpongycastleCryptoModesCTSBlockCipher *new_OrgSpongycastleCryptoModesCTSBlockCipher_initWithOrgSpongycastleCryptoBlockCipher_(id<OrgSpongycastleCryptoBlockCipher> cipher) {
  J2OBJC_NEW_IMPL(OrgSpongycastleCryptoModesCTSBlockCipher, initWithOrgSpongycastleCryptoBlockCipher_, cipher)
}

OrgSpongycastleCryptoModesCTSBlockCipher *create_OrgSpongycastleCryptoModesCTSBlockCipher_initWithOrgSpongycastleCryptoBlockCipher_(id<OrgSpongycastleCryptoBlockCipher> cipher) {
  J2OBJC_CREATE_IMPL(OrgSpongycastleCryptoModesCTSBlockCipher, initWithOrgSpongycastleCryptoBlockCipher_, cipher)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgSpongycastleCryptoModesCTSBlockCipher)
