...
@interface OrgSpongycastleAsn1PkcsRSAPrivateKey () {
 @public
...
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, version__, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, modulus_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, publicExponent_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, privateExponent_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, prime1_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, prime2_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, exponent1_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, exponent2_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, coefficient_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(OrgSpongycastleAsn1PkcsRSAPrivateKey, otherPrimeInfos_, OrgSpongycastleAsn1ASN1Sequence *)

__attribute__((unused)) static void OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithOrgSpongycastleAsn1ASN1Sequence_(OrgSpongycastleAsn1PkcsRSAPrivateKey *self, OrgSpongycastleAsn1ASN1Sequence *seq);

__attribute__((unused)) static OrgSpongycastleAsn1PkcsRSAPrivateKey *new_OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithOrgSpongycastleAsn1ASN1Sequence_(OrgSpongycastleAsn1ASN1Sequence *seq) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgSpongycastleAsn1PkcsRSAPrivateKey *create_OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithOrgSpongycastleAsn1ASN1Sequence_(OrgSpongycastleAsn1ASN1Sequence *seq);

@implementation OrgSpongycastleAsn1PkcsRSAPrivateKey
...
+ (OrgSpongycastleAsn1PkcsRSAPrivateKey *)getInstanceWithOrgSpongycastleAsn1ASN1TaggedObject:(OrgSpongycastleAsn1ASN1TaggedObject *)obj
  ...
  return OrgSpongycastleAsn1PkcsRSAPrivateKey_getInstanceWithOrgSpongycastleAsn1ASN1TaggedObject_withBoolean_(obj, explicit_);
}

+ (OrgSpongycastleAsn1PkcsRSAPrivateKey *)getInstanceWithId:(id)obj {
  return OrgSpongycastleAsn1PkcsRSAPrivateKey_getInstanceWithId_(obj);
}
...
- (instancetype)initWithJavaMathBigInteger:(JavaMathBigInteger *)modulus
  ...
  OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_(self, modulus, publicExponent, privateExponent, prime1, prime2, exponent1, exponent2, coefficient);
  return self;
}

- (instancetype)initWithOrgSpongycastleAsn1ASN1Sequence:(OrgSpongycastleAsn1ASN1Sequence *)seq {
  OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithOrgSpongycastleAsn1ASN1Sequence_(self, seq);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { NULL, "LOrgSpongycastleAsn1PkcsRSAPrivateKey;", 0x9, 0, 1, -1, -1, -1, -1 },
    { NULL, "LOrgSpongycastleAsn1PkcsRSAPrivateKey;", 0x9, 0, 2, -1, -1, -1, -1 },
  ...
  static const J2ObjcClassInfo _OrgSpongycastleAsn1PkcsRSAPrivateKey = { "RSAPrivateKey", "org.spongycastle.asn1.pkcs", ptrTable, methods, fields, 7, 0x1, 14, 10, -1, -1, -1, -1, -1 };
  return &_OrgSpongycastleAsn1PkcsRSAPrivateKey;
}

@end

OrgSpongycastleAsn1PkcsRSAPrivateKey *OrgSpongycastleAsn1PkcsRSAPrivateKey_getInstanceWithOrgSpongycastleAsn1ASN1TaggedObject_withBoolean_(OrgSpongycastleAsn1ASN1TaggedObject *obj, jboolean explicit_) {
  OrgSpongycastleAsn1PkcsRSAPrivateKey_initialize();
  return OrgSpongycastleAsn1PkcsRSAPrivateKey_getInstanceWithId_(OrgSpongycastleAsn1ASN1Sequence_getInstanceWithOrgSpongycastleAsn1ASN1TaggedObject_withBoolean_(obj, explicit_));
}

OrgSpongycastleAsn1PkcsRSAPrivateKey *OrgSpongycastleAsn1PkcsRSAPrivateKey_getInstanceWithId_(id obj) {
  OrgSpongycastleAsn1PkcsRSAPrivateKey_initialize();
  if ([obj isKindOfClass:[OrgSpongycastleAsn1PkcsRSAPrivateKey class]]) {
    return (OrgSpongycastleAsn1PkcsRSAPrivateKey *) obj;
  }
  if (obj != nil) {
    return new_OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithOrgSpongycastleAsn1ASN1Sequence_(OrgSpongycastleAsn1ASN1Sequence_getInstanceWithId_(obj));
  }
  return nil;
}
...
OrgSpongycastleAsn1PkcsRSAPrivateKey *new_OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_(JavaMathBigInteger *modulus, JavaMathBigInteger *publicExponent, JavaMathBigInteger *privateExponent, JavaMathBigInteger *prime1, JavaMathBigInteger *prime2, JavaMathBigInteger *exponent1, JavaMathBigInteger *exponent2, JavaMathBigInteger *coefficient) {
  J2OBJC_NEW_IMPL(OrgSpongycastleAsn1PkcsRSAPrivateKey, initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_, modulus, publicExponent, privateExponent, prime1, prime2, exponent1, exponent2, coefficient)
}

OrgSpongycastleAsn1PkcsRSAPrivateKey *create_OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_(JavaMathBigInteger *modulus, JavaMathBigInteger *publicExponent, JavaMathBigInteger *privateExponent, JavaMathBigInteger *prime1, JavaMathBigInteger *prime2, JavaMathBigInteger *exponent1, JavaMathBigInteger *exponent2, JavaMathBigInteger *coefficient) {
  J2OBJC_CREATE_IMPL(OrgSpongycastleAsn1PkcsRSAPrivateKey, initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_, modulus, publicExponent, privateExponent, prime1, prime2, exponent1, exponent2, coefficient)
}

void OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithOrgSpongycastleAsn1ASN1Sequence_(OrgSpongycastleAsn1PkcsRSAPrivateKey *self, OrgSpongycastleAsn1ASN1Sequence *seq) {
  OrgSpongycastleAsn1ASN1Object_init(self);
  self->otherPrimeInfos_ = nil;
...
OrgSpongycastleAsn1PkcsRSAPrivateKey *new_OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithOrgSpongycastleAsn1ASN1Sequence_(OrgSpongycastleAsn1ASN1Sequence *seq) {
  J2OBJC_NEW_IMPL(OrgSpongycastleAsn1PkcsRSAPrivateKey, initWithOrgSpongycastleAsn1ASN1Sequence_, seq)
}

OrgSpongycastleAsn1PkcsRSAPrivateKey *create_OrgSpongycastleAsn1PkcsRSAPrivateKey_initWithOrgSpongycastleAsn1ASN1Sequence_(OrgSpongycastleAsn1ASN1Sequence *seq) {
  J2OBJC_CREATE_IMPL(OrgSpongycastleAsn1PkcsRSAPrivateKey, initWithOrgSpongycastleAsn1ASN1Sequence_, seq)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgSpongycastleAsn1PkcsRSAPrivateKey)
