...
public class BCDSTU4145PublicKey
    implements ECPublicKey, com.youzh.lingtu.sign.crypto.utils.ECPublicKey, ECPointEncoder
{
    ...
    public BCDSTU4145PublicKey(
            com.youzh.lingtu.sign.crypto.utils.ECPublicKeySpec spec)
    {
        this.q = spec.getQ();
        ...
        else
        {
            if (q.getCurve() == null)
            {
                com.youzh.lingtu.sign.crypto.utils.ECParameterSpec s = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        com.youzh.lingtu.sign.crypto.utils.ECParameterSpec spec = null;
        ...
        else
        {
            ...
            spec = new com.youzh.lingtu.sign.crypto.utils.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
        }
