...
import static com.youzh.lingtu.sign.crypto.utils.Assertions.verifyPrecondition;
...
public class Sign {
    ...
    public static Sign.SignatureData signMessage(byte[] message, ECKeyPair keyPair, boolean isHashed) {
